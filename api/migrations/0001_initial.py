# Generated by Django 2.0.10 on 2019-01-06 20:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('titre', models.CharField(blank=True, max_length=100000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.CharField(blank=True, max_length=100000, null=True)),
                ('matiere', models.CharField(choices=[('PHYSIQUES', 'PHYSIQUES'), ('INFORMATIQUE', 'INFORMATIQUE'), ('CHIMIE', 'CHIMIE'), ('BIOLOGIE', 'BIOLOGIE'), ('LANGUE', 'LANGUE'), ('CULTURE GENERALE', 'CULTURE GENERALE'), ('CULTURE MEDICALE', 'CULTURE MEDICALE'), ('ANCIENNES EPREUVES', 'ANCIENNES EPREUVES'), ('MATHEMATIQUES', 'MATHEMATIQUES'), ('ANGLAIS', 'ANGLAIS')], default='BIOLOGIE', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eleve', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Devoir',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now=True)),
                ('devoir', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Devoir')),
                ('eleve', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classe', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Classe')),
                ('eleve', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Eleve')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapitre', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Chapitre')),
                ('propositions', models.ManyToManyField(to='api.PropositionRelationnelle')),
            ],
        ),
        migrations.CreateModel(
            name='Quizz',
            fields=[
                ...
                ('createur', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='createur_quiz', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quizz', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Quizz')),
                ('utilisateur', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='utilisateur_quiz', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Schema',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('etablissement_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='api.Etablissement')),
                ('idGroupeDeSoutien', models.AutoField(primary_key=True, serialize=False)),
            ],
            bases=('api.etablissement',),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='devoir',
            name='quizz',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Quizz'),
        ),
        migrations.AddField(
            model_name='classe',
            name='enseignant',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Enseignant'),
        ),
        migrations.AddField(
            model_name='chapitreclasse',
            name='classe',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Classe'),
        ),
        ...
        migrations.AddField(
            ...
            name='image',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Schema'),
        ),
        migrations.AddField(
            model_name='annonce',
            name='classe',
        ...
        migrations.AddField(
            model_name='question',
            name='groupe',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.GroupeDeSoutien'),
        ),
        migrations.AlterUniqueTogether(
            name='inscription',
